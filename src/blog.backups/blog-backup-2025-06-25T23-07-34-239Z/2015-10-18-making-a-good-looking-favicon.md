...
![Original Black Box Montreal logo](/img/blog/faviconhowto/original-black-box-logo.png)![Favicon, the easy way.](/img/blog/faviconhowto/favicon-the-easy-way.png)
...
![Favicon: The wrong way.](/img/blog/faviconhowto/favicon-the-wrong-way.png)
...
![An example of raster art.](/img/blog/faviconhowto/raster-example.png)![An example of vector art.](/img/blog/faviconhowto/vector-example.png)
...
![The logo unshaded.](/img/blog/faviconhowto/blackboxmtl-logo-unshaded.png)![The simplified logo, scaled down.](/img/blog/faviconhowto/favicon-simplified-art.png)
...
![The logo shaded.](/img/blog/faviconhowto/blackboxmtl-logo-shaded.png)![The shaded favicon, scaled down.](/img/blog/faviconhowto/favicon-shaded-art.png)
...
![The logo modified so its width and height are equal.](/img/blog/faviconhowto/blackboxmtl-logo-squared.png)![The favicon modified so its width and height are equal.](/img/blog/faviconhowto/favicon-square.png)
...
![A comparison of the steps.](/img/blog/faviconhowto/favicon-steps-comparison.png)
