...
**What we have here are really three different geometric primitives.

**

**The Rook** is easy; it's an orthogonal linemover.
...
**This piece is not possible in 2D chess. It's been called The Merchant or The Mace, but here I'll refer to a triagonal linemover as:
...
****The Chess Piece Formerly Known As Prince.** It can move heterogonally or homogonally. Now appearing as an opening act for Queen, and The King (thankya, thankyaveramuch).
