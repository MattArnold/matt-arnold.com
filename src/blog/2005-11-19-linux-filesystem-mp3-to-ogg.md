...
**[wolfger](https://www.dreamwidth.org/users/ext_177228)** on Nov. 19, 2005 9:32 PM
...
**[brendand](https://www.dreamwidth.org/users/ext_525847)** on Nov. 19, 2005 10:07 PM

Try reinstalling the share-ware? :)

---

**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 19, 2005 10:23 PM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 12:56 AM
...
**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 20, 2005 12:37 AM
...
_for dir in \`echo $MANPATH | tr : ' '\` ; do grep -i vorbis $dir/\*/\* ; done_  
...
_for dir in \`echo $MANPATH | tr : ' '\` ; do grep -i description $dir/\*/\* ; done_  
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 2:43 AM
...
**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 20, 2005 4:11 AM
...
Someone below mentioned the command _apropos_, which I believe does the same thing, only simpler. Try this...  
  
apropos vorbis  
  
Apropos tends to spit out a lot of really nastily formatted stuff, so it may not be simpler afterall, but what it will likely display for _apropos vorbis_ is "vorbis: nothing appropriate".  
  
Amy

---

**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 5:55 AM
...
**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 20, 2005 1:48 PM
...
**[temujin9](https://www.dreamwidth.org/users/ext_5342)** on Nov. 20, 2005 2:54 AM
...
**[wormquartet](https://www.dreamwidth.org/users/ext_259916)** on Nov. 20, 2005 3:06 AM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 3:49 AM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 6:34 AM
...
**[avt-tor](https://www.dreamwidth.org/users/ext_25108)** on Nov. 21, 2005 9:07 PM

And I'm perfectly happy with the command-line interface on my Mac. :)

---

**[overthesun](https://www.dreamwidth.org/users/ext_528985)** on Nov. 20, 2005 3:23 AM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Nov. 20, 2005 3:59 AM

Awesome! Now we're talking.  
  
matt@p4:~$ su matt /usr/bin/abcde  
Password:  
...
**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 20, 2005 4:26 AM

Abcde seems to be a command-line utility to rip CD audio tracks to OGG or MP3, and from that description it may not do the transcoding you want. Its website is [here](http://lly.org/~rcw/abcde/page/).  
  
A .gz file is a compressed file, not an executable. The installer likely unzipped it for you. Try this  
...
**[natashasikorsky](https://www.dreamwidth.org/users/ext_26598)** on Nov. 20, 2005 2:02 PM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Dec. 29, 2005 5:47 AM
