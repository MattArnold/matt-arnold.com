...
_Just follow the usual procedure:_
...
**[stormgren](https://www.dreamwidth.org/users/ext_102523)** on Dec. 2, 2005 11:41 AM
...
**[zifferent](https://www.dreamwidth.org/users/ext_210685)** on Dec. 2, 2005 12:09 PM

here's the voodoo behind the hoodoo:  
  
At a command prompt (most likely as root) you cd to whatever directory you extracted the archive to.  
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Dec. 3, 2005 5:23 PM

OK, at the command prompt (while root) I was in the CD I extracted the archive to, which is tmp. I typed a dot, "./configure" and got this message:  
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Dec. 3, 2005 6:49 PM
...
**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Dec. 14, 2005 2:19 AM — *Re: cooking*
