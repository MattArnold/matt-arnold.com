...
Most important for the non-engineer user is whether you're a happy user, which is supposed to be the whole point for all of us. Don't switch your operating system until and unless it makes you happy, and preferably not until you have a techie friend in case of the occasional error message. It would be nice to let me give you a free Live CD for [Ubuntu (“Linux for Human Beings”)](http://www.ubuntu.com/). A Live CD loads GNU Linux temporarily from your CD drive without replacing Windows at all, so you can sample how easy and attractive Ubuntu is. It's even easier and more attractive with [Automatix](http://www.getautomatix.com/).
...
**[etain](https://www.dreamwidth.org/users/ext_61514)** on Sep. 10, 2006 2:08 PM

So off topic, but I had a few ideas for panels/workshops/thingies. Should I hit up the main list or just bug you?

---

**[matt-arnold](https://www.dreamwidth.org/users/ext_21159)** on Sep. 10, 2006 8:16 PM
