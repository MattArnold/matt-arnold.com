...
Needless to say, anything that I program in Python using the Django web development framework will not be on that list. I'll need to take that code and put it on a web server so that it's a web application. I'm not completely clear on which types of tasks I need to learn. For instance, I assume one uses some kind of command line to do this. And I'd bet good money I should resume reading _UNIX For The Beginning Mage_\*, because it will probably involve understanding directory structure and scripting.

\*Oh no! [His site broke!](http://adminspotting.net/) Good thing I downloaded [the free PDF](http://nemorathwald.com/wp-content/uploads/2008/03/unixforthebeginningmage.pdf).

## Comments

---

**[squeekyhoho](https://www.dreamwidth.org/users/ext_214795)** on Mar. 7, 2008 2:02 PM — *Command-line magic*
