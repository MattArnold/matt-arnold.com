...
At least I _thought_ I had installed Linux on it **(D)**, but I don't know how that could have worked if it can't detect the hard drive and isn't booting from the Feisty Fawn release of [Ubuntu Linux](http://ubuntulinux.com/) which in the CD drive.
...
**[temujin9](https://www.dreamwidth.org/users/ext_5342)** on Apr. 16, 2008 10:14 PM
...
**[zifferent](https://www.dreamwidth.org/users/ext_210685)** on Apr. 16, 2008 10:39 PM

Hmmm, curious.  
  
Does the system use a separate IDE card?  
  
The next thing I'd check is the BIOS battery at this point. Actually can you get into the BIOS? Is the time set?

---

**[zifferent](https://www.dreamwidth.org/users/ext_210685)** on Apr. 16, 2008 11:02 PM

And if there's an IDE card, check it for the battery also.

---

**[crywolf](https://www.dreamwidth.org/users/ext_53192)** on Apr. 16, 2008 11:59 PM
...
**[zifferent](https://www.dreamwidth.org/users/ext_210685)** on Apr. 17, 2008 1:35 AM

My current guess, which I hinted at earlier is that the hard drive is plugged into the external IDE card, no? and the CD-ROM is connected to the motherboard's IDE.  
  
Just a guess, and only on the minimal information provided. Now as to the cause of the failure, there can be many reasons and tests with the actual hardware would work best. If you bring the machine to Penguicon there will be no shortage of experienced and willing technicians that can take a look at it.  
  
Also crywolf's suggestions are very good, they and are designed to rule out multiple possible points of failure, but almost none of these suggestions (including my own) are there to fix your computer in the short-term only to gather more information.
