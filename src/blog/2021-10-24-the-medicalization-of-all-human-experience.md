...
In the past decade, during the rise of medicalization, emotional labor came to be commonly used to mean "having to feel my own feelings", or even just, "if I listen to other people speak about something other than me, they are forcing me to labor for them." I commonly encounter the view, "a speaker must ask permission before raising any conversational topic other than the listener's woundedness, or it is a [consent violation](http://gutsmagazine.ca/emotional-labour/)."

This is called [critique drift](https://inthesetimes.com/article/nyu-grad-students-win-contract).
